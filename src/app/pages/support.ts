...
@Component({
  ...
  template: `
    <div class="pt-16 min-h-screen bg-white">
      <!-- Header Section -->
      <section
        class="bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-12 sm:py-16"
      >
      ...
      <section class="py-16 sm:py-20">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <!-- Knowledge Base -->
            <div
              class="p-8 border border-gray-200 rounded-xl hover:shadow-lg transition-all group"
            >
              <div
                class="w-16 h-16 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center text-3xl mb-4 group-hover:bg-blue-600 group-hover:text-white transition-all"
              >
                📚
              </div>
              ...
              <p class="text-gray-600 mb-6">
                Browse our comprehensive collection of guides, tutorials, and
                FAQs
              </p>
              <button
                class="px-6 py-2 text-blue-600 font-semibold hover:text-blue-700 inline-flex items-center gap-2"
              >
                Explore <span>→</span>
              </button>
            </div>
            ...
            >
              <div
                class="w-16 h-16 bg-purple-100 text-purple-600 rounded-xl flex items-center justify-center text-3xl mb-4 group-hover:bg-purple-600 group-hover:text-white transition-all"
              >
                💬
              </div>
              <h3 class="text-2xl font-semibold text-gray-900 mb-3">
              ...
              <button
                ...
                class="px-6 py-2 text-purple-600 font-semibold hover:text-purple-700 inline-flex items-center gap-2"
              >
            ...
            >
              <div
                class="w-16 h-16 bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center text-3xl mb-4 group-hover:bg-pink-600 group-hover:text-white transition-all"
              >
                👥
              </div>
              <h3 class="text-2xl font-semibold text-gray-900 mb-3">
              ...
              <button
                class="px-6 py-2 text-pink-600 font-semibold hover:text-pink-700 inline-flex items-center gap-2"
              >
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="space-y-4">
            ...
            >
              ...
              >
                <span class="font-semibold text-gray-900 text-left"
                  >How do I reset my password?</span
                >
                <span
                  [ngClass]="{ 'rotate-180': expandedFaq() === 0 }"
              ...
              >
                <p>
                  ...
                  email, and follow the instructions sent to your inbox. The
            ...
            >
              ...
              >
                <span class="font-semibold text-gray-900 text-left"
                  >Can I download course materials?</span
                >
                <span
                  [ngClass]="{ 'rotate-180': expandedFaq() === 1 }"
                  class="text-2xl transition-transform"
                >
                  ▼
                </span>
              ...
              >
                <p>
                  Yes! Course materials are available for download in the course
                  settings. You can access them offline after enrollment. Some
                  courses may have restrictions based on licensing agreements.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                <span
                  [ngClass]="{ 'rotate-180': expandedFaq() === 2 }"
                  class="text-2xl transition-transform"
                >
                  ▼
                </span>
              ...
              >
                <p>
                  Yes! Our mobile app is available on iOS and Android. You can
                  continue learning on the go with offline access to course
                  materials and synchronized progress across devices.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                <span
                  [ngClass]="{ 'rotate-180': expandedFaq() === 3 }"
                  class="text-2xl transition-transform"
                >
                  ▼
                </span>
              ...
              >
                <p>
                  We offer a 30-day money-back guarantee for all courses. If
            ...
            >
              ...
              >
                <span class="font-semibold text-gray-900 text-left"
                  >How do I verify my certificate?</span
                >
                <span
                  [ngClass]="{ 'rotate-180': expandedFaq() === 4 }"
                  class="text-2xl transition-transform"
                >
                  ▼
                </span>
              ...
              >
                <p>
                  Each certificate has a unique verification ID. Employers and
                  institutions can verify your credentials on our verification
                  portal using this ID. Your certificate is valid indefinitely.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="contact" class="py-16 sm:py-20 bg-white">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            class="bg-gradient-to-br from-slate-50 to-gray-100 rounded-2xl p-8 border border-gray-200"
          >
