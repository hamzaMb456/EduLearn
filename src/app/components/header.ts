      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <nav class="hidden md:flex items-center gap-8">
            ...
            <a
              routerLink="/support"
              class="text-gray-700 hover:text-blue-600 transition-colors font-medium text-sm cursor-pointer"
              >Support</a
            >
          </nav>
          ...
          <div class="flex items-center gap-4">
            <a
              routerLink="/login"
              class="text-gray-700 hover:text-blue-600 transition-colors font-medium text-sm hidden sm:inline cursor-pointer"
            >
              Sign In
            </a>
            <a
              routerLink="/signup"
              class="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold text-sm hover:shadow-lg hover:shadow-blue-200 transition-all inline-block"
            >
              Get Started
            </a>
          </div>
